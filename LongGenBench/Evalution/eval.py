...
# llm = LLM(model="meta-llama/Llama-3.1-8B-Instruct", tensor_parallel_size=args.gpu, dtype="bfloat16", quantization=None)
llm = LLM(model="/home/rhg659/MorphKV_plus/model_chkpts/models--meta-llama--Llama-3.1-8B-Instruct/snapshots/0e9e39f249a16976918f6564b8830bc894c89659", tensor_parallel_size=args.gpu, dtype="float16", quantization=None)
